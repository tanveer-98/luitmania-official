      ...
      <footer className="bg-gradient-footer text-center text-white">
        <div className=" px-6 py-2 w-full ">
          <div className=" flex justify-center w-full">
            ...
            <a
              ...
              className=" m-1 h-9 w-9 rounded-full border-2 border-white uppercase leading-normal text-white transition duration-150 ease-in-out hover:bg-black hover:bg-opacity-40 focus:outline-none focus:ring-0"
              data-te-ripple-init
        ...
        >
          ...
          <p className="text-sm md:text-lg">
            Designed By{" "}
            <a
              className="ml-4 text-blue-600 hover:text-white"
              href="https://luitomania-official.netlify.app/"
            >
              Luitomania
            </a>
          </p>
